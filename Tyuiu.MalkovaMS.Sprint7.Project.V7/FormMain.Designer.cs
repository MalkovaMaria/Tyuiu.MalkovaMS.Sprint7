namespace Tyuiu.MalkovaMS.Sprint7.Project.V7
{
    partial class FormMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            ColumnAppartment_MMS = new DataGridViewTextBoxColumn();
            ColumnPloshad_MMS = new DataGridViewTextBoxColumn();
            ColumnRooms_MMS = new DataGridViewTextBoxColumn();
            ColumnFamilia_MMS = new DataGridViewTextBoxColumn();
            ColumnDate_MMS = new DataGridViewTextBoxColumn();
            ColumnPeople_MMS = new DataGridViewTextBoxColumn();
            ColumnKids_MMS = new DataGridViewTextBoxColumn();
            ColumnPay_MMS = new DataGridViewTextBoxColumn();
            panelTools_MMS = new Panel();
            groupBoxFilter_MMS = new GroupBox();
            buttonClearFilter_MMS = new Button();
            ...
            panelMainPay_MMS = new Panel();
            dataGridViewPayStat_MMS = new DataGridView();
            ColumnNumberPay_MMS = new DataGridViewTextBoxColumn();
            ColumnPeriod_MMS = new DataGridViewTextBoxColumn();
            ColumnSumPay_MMS = new DataGridViewTextBoxColumn();
            ColumnStatPay_MMS = new DataGridViewTextBoxColumn();
            panelTopPay_MMS = new Panel();
            groupBoxFilterPay_MMS = new GroupBox();
            buttonClearFilterPay_MMS = new Button();
            comboBoxStatusPay_MMS = new ComboBox();
            buttonFilterPay_MMS = new Button();
            labelStatusPay_MMS = new Label();
            groupBoxFilePay_MMS = new GroupBox();
            buttonAddFilePay_MMS = new Button();
            buttonSaveFilePay_MMS = new Button();
            groupBoxChangePay_MMS = new GroupBox();
            buttonMarkPaid_MMS = new Button();
            buttonRefreshPay_MMS = new Button();
            buttonEditRowPay_MMS = new Button();
            buttonDelRowPay_MMS = new Button();
            buttonAddRowPay_MMS = new Button();
            tabPageStat_MMS = new TabPage();
            splitterCenterStat_MMS = new Splitter();
            panelRight_Stat = new Panel();
            groupBoxTypesOfAppatments_MMS = new GroupBox();
            chartTypesStat_MMS = new System.Windows.Forms.DataVisualization.Charting.Chart();
            groupBoxFamilyStat_MMS = new GroupBox();
            ...
            labelSrPloshad_MMS = new Label();
            labelAllKv_MMS = new Label();
            labelAllPeople_MMS = new Label();
            panelHeaderStat_MMS = new Panel();
            labelHeaderStat_MMS = new Label();
            ...
            saveFileDialog_MMS = new SaveFileDialog();
            openFileDialogPay_MMS = new OpenFileDialog();
            saveFileDialogPay_MMS = new SaveFileDialog();
            toolStripMenuItemOpenFile_MMS = new ToolStripMenuItem();
            toolStripMenuItemSaveFile_MMS = new ToolStripMenuItem();
            toolStripMenuItemNewFile_MMS = new ToolStripMenuItem();
            базаДанныхToolStripMenuItem = new ToolStripMenuItem();
            информацияОПлатежахToolStripMenuItem = new ToolStripMenuItem();
            базаДанныхToolStripMenuItem1 = new ToolStripMenuItem();
            информацияОПлатежахToolStripMenuItem1 = new ToolStripMenuItem();
            ...
            tabPagePayInfo_MMS.SuspendLayout();
            panelMainPay_MMS.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)dataGridViewPayStat_MMS).BeginInit();
            panelTopPay_MMS.SuspendLayout();
            groupBoxFilterPay_MMS.SuspendLayout();
            groupBoxFilePay_MMS.SuspendLayout();
            groupBoxChangePay_MMS.SuspendLayout();
            tabPageStat_MMS.SuspendLayout();
            panelRight_Stat.SuspendLayout();
            groupBoxTypesOfAppatments_MMS.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)chartTypesStat_MMS).BeginInit();
            groupBoxFamilyStat_MMS.SuspendLayout();
            ...
            // 
            dataGridViewTable_MMS.AllowUserToAddRows = false;
            dataGridViewTable_MMS.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            dataGridViewTable_MMS.BackgroundColor = SystemColors.Menu;
            dataGridViewTable_MMS.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dataGridViewTable_MMS.Columns.AddRange(new DataGridViewColumn[] { ColumnAppartment_MMS, ColumnPloshad_MMS, ColumnRooms_MMS, ColumnFamilia_MMS, ColumnDate_MMS, ColumnPeople_MMS, ColumnKids_MMS, ColumnPay_MMS });
            ...
            // panelTools_MMS
            // 
            panelTools_MMS.BackColor = SystemColors.Menu;
            ...
            // groupBoxFilter_MMS
            // 
            groupBoxFilter_MMS.Controls.Add(buttonClearFilter_MMS);
            ...
            buttonClearFilter_MMS.UseVisualStyleBackColor = false;
            buttonClearFilter_MMS.Click += buttonClearFilter_MMS_Click;
            // 
            // comboBoxColumn_MMS
            // 
            ...
            buttonFilter_MMS.UseVisualStyleBackColor = false;
            buttonFilter_MMS.Click += buttonFilter_MMS_Click;
            // 
            ...
            buttonAddFile_MMS.Click += buttonAddFile_MMS_Click;
            // 
            // buttonSaveFile_MMS
            // 
            ...
            buttonSaveFile_MMS.Click += buttonSaveFile_MMS_Click;
            // 
            // groupBoxChange_MMS
            // 
            ...
            // 
            dataGridViewPayStat_MMS.AllowUserToAddRows = false;
            dataGridViewPayStat_MMS.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            dataGridViewPayStat_MMS.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dataGridViewPayStat_MMS.Columns.AddRange(new DataGridViewColumn[] { ColumnNumberPay_MMS, ColumnPeriod_MMS, ColumnSumPay_MMS, ColumnStatPay_MMS });
            dataGridViewPayStat_MMS.Dock = DockStyle.Fill;
            dataGridViewPayStat_MMS.Location = new Point(0, 0);
            ...
            // panelTopPay_MMS
            // 
            panelTopPay_MMS.BackColor = SystemColors.Menu;
            panelTopPay_MMS.Controls.Add(groupBoxFilterPay_MMS);
            ...
            // 
            groupBoxFilterPay_MMS.Controls.Add(buttonClearFilterPay_MMS);
            ...
            buttonClearFilterPay_MMS.UseVisualStyleBackColor = false;
            buttonClearFilterPay_MMS.Click += buttonClearFilterPay_MMS_Click;
            // 
            ...
            buttonFilterPay_MMS.UseVisualStyleBackColor = false;
            buttonFilterPay_MMS.Click += buttonFilterPay_MMS_Click;
            // 
            // labelStatusPay_MMS
            // 
            ...
            buttonAddFilePay_MMS.Click += buttonAddFilePay_MMS_Click;
            // 
            // buttonSaveFilePay_MMS
            // 
            ...
            buttonSaveFilePay_MMS.Click += buttonSaveFilePay_MMS_Click;
            // 
            // groupBoxChangePay_MMS
            // 
            groupBoxChangePay_MMS.Controls.Add(buttonMarkPaid_MMS);
            groupBoxChangePay_MMS.Controls.Add(buttonRefreshPay_MMS);
            ...
            // buttonMarkPaid_MMS
            // 
            buttonMarkPaid_MMS.BackColor = SystemColors.ControlLightLight;
            ...
            buttonMarkPaid_MMS.Click += buttonMarkPaid_MMS_Click;
            // 
            // buttonRefreshPay_MMS
            // 
            ...
            buttonRefreshPay_MMS.Click += buttonRefreshPay_MMS_Click;
            // 
            // buttonEditRowPay_MMS
            // 
            ...
            buttonEditRowPay_MMS.Click += buttonEditRowPay_MMS_Click;
            // 
            // buttonDelRowPay_MMS
            // 
            ...
            buttonDelRowPay_MMS.Click += buttonDelRowPay_MMS_Click;
            // 
            // buttonAddRowPay_MMS
            // 
            ...
            buttonAddRowPay_MMS.Click += buttonAddRowPay_MMS_Click;
            // 
            // tabPageStat_MMS
            // 
            tabPageStat_MMS.BackColor = SystemColors.ControlLightLight;
            tabPageStat_MMS.Controls.Add(splitterCenterStat_MMS);
            ...
            splitterCenterStat_MMS.Size = new Size(3, 542);
            splitterCenterStat_MMS.TabIndex = 3;
            splitterCenterStat_MMS.TabStop = false;
            // 
            // panelRight_Stat
            // 
            panelRight_Stat.BackColor = SystemColors.ControlLightLight;
            ...
            panelRight_Stat.Size = new Size(605, 542);
            ...
            groupBoxTypesOfAppatments_MMS.Size = new Size(605, 280);
            ...
            chartTypesStat_MMS.ChartAreas.Add(chartArea3);
            chartTypesStat_MMS.Dock = DockStyle.Fill;
            legend3.Name = "Legend1";
            chartTypesStat_MMS.Legends.Add(legend3);
            ...
            chartTypesStat_MMS.Series.Add(series3);
            chartTypesStat_MMS.Size = new Size(599, 254);
            chartTypesStat_MMS.TabIndex = 1;
            chartTypesStat_MMS.Text = "chart2";
            // 
            // groupBoxFamilyStat_MMS
            // 
            ...
            chartKidsStat_MMS.ChartAreas.Add(chartArea4);
            chartKidsStat_MMS.Dock = DockStyle.Fill;
            legend4.Name = "Legend1";
            chartKidsStat_MMS.Legends.Add(legend4);
            ...
            series4.Font = new Font("Segoe UI Semibold", 8.25F, FontStyle.Bold, GraphicsUnit.Point, 204);
            series4.Legend = "Legend1";
            series4.Name = "Series1";
            chartKidsStat_MMS.Series.Add(series4);
            ...
            // panelLeftStat_MMS
            // 
            panelLeftStat_MMS.BackColor = SystemColors.ControlLightLight;
            ...
            panelLeftStat_MMS.Size = new Size(618, 542);
            ...
            groupBoxPayStat_MMS.Size = new Size(618, 280);
            ...
            panelBars_MMS.Size = new Size(612, 254);
            panelBars_MMS.TabIndex = 0;
            panelBars_MMS.Paint += panelBars_MMS_Paint;
            // 
            // groupBoxMainMetrics_MMS
            // 
            groupBoxMainMetrics_MMS.Controls.Add(labelMaksPloshad_MMS);
            groupBoxMainMetrics_MMS.Controls.Add(labelMinPloshad_MMS);
            groupBoxMainMetrics_MMS.Controls.Add(labelSrPloshad_MMS);
            ...
            groupBoxMainMetrics_MMS.TabIndex = 0;
            groupBoxMainMetrics_MMS.TabStop = false;
            groupBoxMainMetrics_MMS.Text = "Общие метрики";
            // 
            // labelMaksPloshad_MMS
            // 
            ...
            // panelHeaderStat_MMS
            // 
            panelHeaderStat_MMS.BackColor = SystemColors.MenuBar;
            panelHeaderStat_MMS.BorderStyle = BorderStyle.FixedSingle;
            panelHeaderStat_MMS.Controls.Add(labelHeaderStat_MMS);
            panelHeaderStat_MMS.Dock = DockStyle.Top;
            ...
            // 
            файлToolStripMenuItem_MMS.DropDownItems.AddRange(new ToolStripItem[] { toolStripMenuItemNewFile_MMS, toolStripMenuItemOpenFile_MMS, toolStripMenuItemSaveFile_MMS, выходToolStripMenuItem_MMS });
            ...
            выходToolStripMenuItem_MMS.Size = new Size(180, 22);
            ...
            // openFileDialog_MMS
            // 
            openFileDialog_MMS.FileName = "openFileDialog1";
            // 
            // openFileDialogPay_MMS
            // 
            openFileDialogPay_MMS.FileName = "openFileDialog1";
            // 
            ...
            toolStripMenuItemOpenFile_MMS.Size = new Size(180, 22);
            toolStripMenuItemOpenFile_MMS.Text = "Открыть файл";
            // 
            // toolStripMenuItemSaveFile_MMS
            // 
            ...
            toolStripMenuItemSaveFile_MMS.Size = new Size(180, 22);
            toolStripMenuItemSaveFile_MMS.Text = "Сохранить файл";
            // 
            // toolStripMenuItemNewFile_MMS
            // 
            toolStripMenuItemNewFile_MMS.Name = "toolStripMenuItemNewFile_MMS";
            toolStripMenuItemNewFile_MMS.Size = new Size(180, 22);
            toolStripMenuItemNewFile_MMS.Text = "Создать файл";
            // 
            ...
            tabPagePayInfo_MMS.ResumeLayout(false);
            panelMainPay_MMS.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)dataGridViewPayStat_MMS).EndInit();
            panelTopPay_MMS.ResumeLayout(false);
            groupBoxFilterPay_MMS.ResumeLayout(false);
            groupBoxFilterPay_MMS.PerformLayout();
            groupBoxFilePay_MMS.ResumeLayout(false);
            groupBoxChangePay_MMS.ResumeLayout(false);
            tabPageStat_MMS.ResumeLayout(false);
            panelRight_Stat.ResumeLayout(false);
            groupBoxTypesOfAppatments_MMS.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)chartTypesStat_MMS).EndInit();
            groupBoxFamilyStat_MMS.ResumeLayout(false);
            ...
            panelHeaderStat_MMS.PerformLayout();
        ...
        private ToolStripMenuItem полноэкранныйРежимToolStripMenuItem_MMS;
        private Panel panelHeaderStat_MMS;
        private Label labelHeaderStat_MMS;
        private Panel panelRight_Stat;
        private Panel panelLeftStat_MMS;
        private GroupBox groupBoxFamilyStat_MMS;
        private GroupBox groupBoxMainMetrics_MMS;
        private GroupBox groupBoxTypesOfAppatments_MMS;
        private GroupBox groupBoxPayStat_MMS;
        private Splitter splitterCenterStat_MMS;
        private Label labelAllPeople_MMS;
        private Label labelMaksPloshad_MMS;
        private Label labelMinPloshad_MMS;
        private Label labelSrPloshad_MMS;
        private Label labelAllKv_MMS;
        private Panel panelTopPay_MMS;
        private GroupBox groupBoxFilePay_MMS;
        private Button buttonAddFilePay_MMS;
        private Button buttonSaveFilePay_MMS;
        private GroupBox groupBoxChangePay_MMS;
        private Button buttonRefreshPay_MMS;
        private Button buttonEditRowPay_MMS;
        private Button buttonDelRowPay_MMS;
        private Button buttonAddRowPay_MMS;
        private Panel panelMainPay_MMS;
        private DataGridView dataGridViewPayStat_MMS;
        private DataGridViewTextBoxColumn ColumnNumberPay_MMS;
        ...
        private Button buttonClearFilter_MMS;
        private DataGridViewTextBoxColumn ColumnAppartment_MMS;
        private DataGridViewTextBoxColumn ColumnPloshad_MMS;
        private DataGridViewTextBoxColumn ColumnRooms_MMS;
        private DataGridViewTextBoxColumn ColumnFamilia_MMS;
        private DataGridViewTextBoxColumn ColumnDate_MMS;
        private DataGridViewTextBoxColumn ColumnPeople_MMS;
        private DataGridViewTextBoxColumn ColumnKids_MMS;
        private DataGridViewTextBoxColumn ColumnPay_MMS;
        private OpenFileDialog openFileDialogPay_MMS;
        private SaveFileDialog saveFileDialogPay_MMS;
        private GroupBox groupBoxFilterPay_MMS;
        private Button buttonClearFilterPay_MMS;
        private ComboBox comboBoxStatusPay_MMS;
        ...
        private ToolStripMenuItem toolStripMenuItemNewFile_MMS;
        private ToolStripMenuItem toolStripMenuItemOpenFile_MMS;
        private ToolStripMenuItem базаДанныхToolStripMenuItem;
        private ToolStripMenuItem информацияОПлатежахToolStripMenuItem;
        private ToolStripMenuItem toolStripMenuItemSaveFile_MMS;
        private ToolStripMenuItem базаДанныхToolStripMenuItem1;
        private ToolStripMenuItem информацияОПлатежахToolStripMenuItem1;
    }
}
